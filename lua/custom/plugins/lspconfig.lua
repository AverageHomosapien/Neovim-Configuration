	...
	config = function()
		...
		vim.api.nvim_create_autocmd("LspAttach", {
			...
			callback = function(event)
				...
				vim.keymap.set("n", "<leader>D", builtin.lsp_type_definitions, "Type [D]efinition")
				...
				vim.keymap.set("n", "<leader>ws", builtin.lsp_dynamic_workspace_symbols, "[W]orkspace [S]ymbols")
